...
import {SelectedType, TabsType} from "@/types";
import {tabsList} from "@/views/Tabs/Tabs.data";

const tabs = ref<TabsType>(tabsList)
const selectedTab = ref<SelectedType>('Vue')

const changeTab = (tabName: SelectedType): void => {
